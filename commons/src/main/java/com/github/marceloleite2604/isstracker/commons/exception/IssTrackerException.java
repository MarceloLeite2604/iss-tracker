...
import com.github.marceloleite2604.isstracker.commons.util.SiteApplicationContext;

public class IssTrackerException extends Exception {

	private static final long serialVersionUID = 1L;

	protected static final Blimp BLIMP = SiteApplicationContext.retrieveBean(Blimp.class);
